...
import { useCommunityActions } from 'src/pages/bookmark/tabs/communities/useCommunityActions.tsx';
import {
  CommunitiyDto,
  CommunityStatus,
  CommunityUser,
...
export const CommunitiesList = observer(
  ({ communities }: CommunitiesListProps) => {
    ...
    const { getActionsByStatus, agreementModal } = useCommunityActions({
    ...
    if (communities.length === 0 && !isCommunityLoading) {
